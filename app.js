const API_KEY= `4b42d65fddd0e1b9ccc5161ae74e839a`
  ...
  popup_container.innerHTML=`
      ...
      <div class="content">
        ...
        <div class="right">
          ...
          <div class="trailer">
            <h2>Trailer</h2>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/K${movie_trailer}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>
      </div>
  `
